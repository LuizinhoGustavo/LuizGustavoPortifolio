...
export function AboutMe() {
    return (
        <div className="flex flex-col md:flex-row h-full justify-center items-center gap-10 text-textColor">
            ...
            <a href={curriculum} target="_blank" className="w-44 md:w-44 bg-transparent border border-orangeColor text-orangeColor flex flex-col justify-center h-12 my-auto align-middle px-7 rounded-b-3xl rounded-l-3xl hover:text-white font-bold hover:bg-orangeColor duration-700">
